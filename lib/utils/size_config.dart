...
class SizeConfig {
  ...
  //sebelum di deploy ke platform yang spesifik,
  //mendapatkan ukuran aktual dari platform tersebut 
  //(misal: dideploy ke platform android)
  static double screenWidth = 0.0;
  static double screenHeight = 0.0;
  static double defaultSize = 0.0;

// fungsi dari fuction ini adalah untuk pemanggilan awal ketika aplikasi di jalankan.
// dan untuk mendapatkan ukuran dari layar platform
  void init(BuildContext context) {
    // berfungsi untuk mengambil ukuran aktual dari platform 
    // karena di dalanm variable _mediaQueryData...
...
// menggunakan standar dari handphone iphone x (812 x 375)
double getProporsionateScreenHeight(double inputHeight) {
  double screenHeight = SizeConfig.screenHeight;
  // ini adalah perhitungan untuk menghasilkan nilai dan ukran objek yang responsif sesuai dengan platform
...
double getProporsionateScreenWidth(double inputWidth) {
  ...
  return(inputWidth / 375.0) * screenWidth; // todo;
}