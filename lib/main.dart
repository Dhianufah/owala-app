  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      theme: ThemeData(
        ...
        visualDensity: VisualDensity.adaptivePlatformDensity,  // untuk mengatur kepadatan di setiap platform/ buat menyesuaikan responsif di setiap device
        textTheme: TextTheme(
      ...
      // initial route: untuk mendefinisikan kelas apa yang akan tampil pertama saat apalikasi dijalankan
      initialRoute: '/login',
      routes: {
